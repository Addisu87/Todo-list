...
/***/ "./modules/addEditRemove.js":
/*!**********************************!*\
  !*** ./modules/addEditRemove.js ***!
  \**********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"addItem\": () => (/* binding */ addItem),\n/* harmony export */   \"deleteItem\": () => (/* binding */ deleteItem),\n/* harmony export */   \"editItem\": () => (/* binding */ editItem)\n/* harmony export */ });\n/* harmony import */ var _src_style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../src/style.css */ \"./src/style.css\");\n/* harmony import */ var _showAlert_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./showAlert.js */ \"./modules/showAlert.js\");\n/* harmony import */ var _displayTodos_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./displayTodos.js */ \"./modules/displayTodos.js\");\n\n\n\n\nconst addItem = (content) => {\n  const todos = (JSON.parse(localStorage.getItem('todos')) || []).filter(\n    (todo) => todo.content !== '',\n  );\n\n  const todo = {\n    content,\n    done: false,\n    createdAt: new Date().getTime(),\n  };\n\n  // Validate\n  if (todo.content === '') {\n    (0,_showAlert_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])('Please fill in the field', 'danger');\n  } else {\n    (0,_showAlert_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])('To-do list added', 'success');\n    todos.push(todo);\n    localStorage.setItem('todos', JSON.stringify(todos));\n    (0,_displayTodos_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])();\n  }\n};\n\nconst editItem = (i, e) => {\n  const todos = JSON.parse(localStorage.getItem('todos')) || [];\n  const task = todos.find((todo, index) => index === i);\n  const newDescription = e.target.value;\n  task.content = newDescription;\n  todos[i] = task;\n  localStorage.setItem('todos', JSON.stringify(todos));\n};\n\nconst deleteItem = (i) => {\n  let todos = JSON.parse(localStorage.getItem('todos')) || [];\n  todos = todos.filter((_, index) => index !== i);\n  localStorage.setItem('todos', JSON.stringify(todos));\n};\n\n\n\n\n//# sourceURL=webpack://webpack-demo/./modules/addEditRemove.js?");
