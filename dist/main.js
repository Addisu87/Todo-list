...
/***/ "./modules/addEditDelete.js":
/*!**********************************!*\
  !*** ./modules/addEditDelete.js ***!
  \**********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"addItem\": () => (/* binding */ addItem),\n/* harmony export */   \"deleteItem\": () => (/* binding */ deleteItem),\n/* harmony export */   \"editItem\": () => (/* binding */ editItem),\n/* harmony export */   \"removeAllDone\": () => (/* binding */ removeAllDone),\n/* harmony export */   \"updateTaskStatus\": () => (/* binding */ updateTaskStatus)\n/* harmony export */ });\nvar addItem = function addItem(content, todos) {\n  var newTodos = todos.filter(function (todo) {\n    return todo.content !== '';\n  });\n  var todo = {\n    content: content,\n    done: false,\n    createdAt: new Date().getTime()\n  };\n  newTodos.push(todo);\n  return newTodos;\n};\n\nvar editItem = function editItem(todos, itemIndex, content) {\n  var newTodos = todos;\n  var task = newTodos.find(function (_, index) {\n    return index === itemIndex;\n  });\n  task.content = content;\n  newTodos[itemIndex] = task;\n  return newTodos;\n};\n\nvar updateTaskStatus = function updateTaskStatus(todos, itemIndex, status) {\n  var newTodos = todos;\n  var task = newTodos.find(function (_, index) {\n    return index === itemIndex;\n  });\n  task.done = status;\n  newTodos[itemIndex] = task;\n  return newTodos;\n};\n\nvar deleteItem = function deleteItem(i, todos) {\n  return todos.filter(function (_, index) {\n    return index !== i;\n  });\n};\n\nvar removeAllDone = function removeAllDone(todos) {\n  return todos.filter(function (todo) {\n    return !todo.done;\n  });\n};\n\n\n\n//# sourceURL=webpack://webpack-demo/./modules/addEditDelete.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _addEditDelete_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./addEditDelete.js */ \"./modules/addEditDelete.js\");\n\n\nvar displayTodos = function displayTodos() {\n  var todos = JSON.parse(localStorage.getItem('todos')) || [];\n  var todoList = document.querySelector('#todo-list');\n  todoList.innerHTML = '';\n  todos.sort(function (a, b) {\n    return a.index - b.index;\n  }).forEach(function (todo, i) {\n    var todoItem = document.createElement('div');\n    todoItem.classList.add('todo-item');\n    var label = document.createElement('label');\n    var checkBox = document.createElement('input');\n    checkBox.type = 'checkbox';\n    checkBox.checked = todo.done;\n    label.appendChild(checkBox);\n    var span = document.createElement('span');\n    span.classList.add('bubble');\n    label.appendChild(span);\n    var content = document.createElement('div');\n    content.classList.add('todo-content');\n    content.innerHTML = \"<input type=\\\"text\\\" id=\\\"\".concat(i, \"input\\\" value=\\\"\").concat(todo.content, \"\\\" readonly />\");\n    var actions = document.createElement('div');\n    actions.classList.add('actions');\n    var edit = document.createElement('button');\n    edit.classList.add('edit');\n    edit.innerHTML = 'Edit';\n    actions.appendChild(edit);\n    var deleteButton = document.createElement('button');\n    deleteButton.classList.add('delete');\n    deleteButton.innerHTML = 'Delete';\n    actions.appendChild(deleteButton);\n    todoItem.appendChild(label);\n    todoItem.appendChild(content);\n    todoItem.appendChild(actions);\n    todoList.appendChild(todoItem);\n\n    if (todo.done) {\n      todoItem.classList.add('done');\n    }\n\n    checkBox.addEventListener('change', function (e) {\n      todo.done = e.target.checked;\n      var newTodos = (0,_addEditDelete_js__WEBPACK_IMPORTED_MODULE_0__.updateTaskStatus)(todos, i, e.target.checked);\n      localStorage.setItem('todos', JSON.stringify(newTodos));\n\n      if (todo.done) {\n        todoItem.classList.add('done');\n      } else {\n        todoItem.classList.remove('done');\n      }\n\n      displayTodos();\n    });\n    edit.addEventListener('click', function () {\n      var input = document.getElementById(\"\".concat(i, \"input\"));\n      input.removeAttribute('readonly');\n      input.focus();\n      input.addEventListener('blur', function () {\n        input.setAttribute('readonly', true);\n        var newTodos = (0,_addEditDelete_js__WEBPACK_IMPORTED_MODULE_0__.editItem)(todos, i, input.value);\n        localStorage.setItem('todos', JSON.stringify(newTodos));\n        displayTodos();\n      });\n      input.addEventListener('change', function (e) {\n        input.value = e.target.value;\n      });\n    });\n    deleteButton.addEventListener('click', function () {\n      var newTodos = (0,_addEditDelete_js__WEBPACK_IMPORTED_MODULE_0__.deleteItem)(i, todos);\n      localStorage.setItem('todos', JSON.stringify(newTodos));\n      displayTodos();\n    });\n  });\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (displayTodos);\n\n//# sourceURL=webpack://webpack-demo/./modules/displayTodos.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _displayTodos_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./displayTodos.js */ \"./modules/displayTodos.js\");\n/* harmony import */ var _addEditDelete_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./addEditDelete.js */ \"./modules/addEditDelete.js\");\n\n\n\nvar clearAllTasks = function clearAllTasks() {\n  var clearTasks = document.querySelector('#completed');\n  clearTasks.innerHTML = '';\n  var removeAll = document.createElement('button');\n  removeAll.classList.add('completed');\n  removeAll.innerHTML = 'Remove All';\n  clearTasks.appendChild(removeAll);\n  removeAll.addEventListener('click', function () {\n    var todos = JSON.parse(localStorage.getItem('todos')) || [];\n    var notRemoved = (0,_addEditDelete_js__WEBPACK_IMPORTED_MODULE_1__.removeAllDone)(todos);\n    localStorage.setItem('todos', JSON.stringify(notRemoved));\n    (0,_displayTodos_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\n  });\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (clearAllTasks);\n\n//# sourceURL=webpack://webpack-demo/./modules/removeAll.js?");
